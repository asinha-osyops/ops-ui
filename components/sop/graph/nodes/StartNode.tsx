...
function StartNodeComponent({
  ...
  return (
    <div
      className={cn(
        'group relative bg-orange-50 dark:bg-orange-950/20 border border-orange-300 dark:border-orange-800 border-l-4 border-l-green-500 dark:border-l-green-400',
